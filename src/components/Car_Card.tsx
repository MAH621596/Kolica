...
const CarCard = ({
    ...
    return (
        dealerText ? <>
            <Link to="/" className="h-[206px] w-[206px] flex flex-col items-center justify-center bg-[#253A86] border border-[#253A86] rounded-[10px]">
            ...
            <div className={`group flex flex-col items-center justify-center cursor-pointer gap-0 h-[206px] w-[206px] bg-[#F1F1F1] border border-[#C8C8C8] rounded-[10px] ${className}`}>
                <div className="card_header flex items-center justify-center h-[40px]">
                    <Link to="/" className="font-bold text-sm md:text-[13px] lg:text-[15px] leading-[20px] text-[#000000] group-hover:underline decoration-1">{heading}</Link>
                </div>
