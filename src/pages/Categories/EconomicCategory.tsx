...
import { homePagetabsMenu, economicCategoryData, economicSparePartsData } from '@/helper/data';
...
const EconomicCategory = () => {
    ...
    const [activeMainTab, setActiveMainTab] = useState<number>(4);
            ...
            <section className="md:px-4 lg:px-0">
                ...
                <HeroCard>
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[25px]">
                            {economicCategoryData.map((category) => {
                                return (
                                    <CategoriesCard
                                        icon={category.icon}
                ...
                <HeroCard>
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[25px]">
                            {economicSparePartsData.map((spareParts) => {
                                return (
                                    <CategoriesCard
...
export default EconomicCategory;