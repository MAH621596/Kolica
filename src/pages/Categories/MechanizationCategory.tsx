...
import { homePagetabsMenu, mechanizationCategoryData, mechanizationSparePartsData } from '@/helper/data';
            ...
            <section className="md:px-4 lg:px-0">
                ...
                <HeroCard>
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[25px]">
                            {mechanizationCategoryData.map((category) => {
                                return (
                                    <CategoriesCard
                                        icon={category.icon}
                ...
                <HeroCard>
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[25px]">
                            {mechanizationSparePartsData.map((spareParts) => {
                                return (
                                    <CategoriesCard
...
export default MechanizationCategory;