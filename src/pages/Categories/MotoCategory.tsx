...
import { homePagetabsMenu, motoCategoryData, motoSparePartsData } from '@/helper/data';
import { Navbar, HeroCard, CarCard, Tabs, CustomInput, CategoriesCard, Footer } from "@/components";
import { Byke1, Byke2, Byke3, SeeMore, Sorting } from "@/assets";
            ...
            <section className="md:px-4 lg:px-0">
                ...
                <HeroCard>
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[25px]">
                            {motoSparePartsData.map((spareParts) => {
                                return (
                                    <CategoriesCard
                ...
                <div className="md:mb-[100px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center gap-[18px] lg:gap-[26px] 
                    ...
                    <CarCard image={Byke1} heading="Xmotos RACER PRO XXX..." price="$28,900" />
                    <CarCard image={Byke2} heading="ATV VULCANO 1000W o...0" price="$28,900" />
                    <CarCard image={Byke3} heading="Mini Moto GAZZELE ALL..." price="$28,900" />
