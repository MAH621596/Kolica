        ...
        >
            ...
            <section className="md:px-4 lg:px-0">
                <HeroCard>
                    <div>
                        ...
                        <div className="relative">
                            <Button pre={true} type="button" text="Select a Photo to post" className="mx-auto w-full lg:w-[385px] flex justify-center mt-[25px] !bg-[#B1222C] border-[#B1222C] font-semibold text-xs lg:text-[18px] !text-white h-[41px] hover:scale-110" />
                        </div>
                    </div>
                </HeroCard>
                ...
                <HeroCard>
                    ...
                    <Button pre={true} type="button" text="Finish editing" className="mt-[50px] w-full flex justify-center !bg-[#B1222C] border-[#B1222C] font-semibold text-xs lg:text-[16px] !text-white h-[35px] hover:scale-110" />
                </HeroCard>
